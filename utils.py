...
if __name__ == '__main__':
    ...
    tokenizer = AutoTokenizer.from_pretrained('/home/worker/nlp/hao/bert-base-chinese')
    example = {'text': ['娱乐	嗨放派怎么停播了']}
    template = HardTemplate(
        prompt='这是一条{MASK}评论：{textA}'
    )
    result = convert_example(example, tokenizer, 256, 2, template)
    print(result)
